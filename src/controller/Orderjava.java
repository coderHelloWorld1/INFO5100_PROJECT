...
public class Ordercontroller_upsemp {
     ...
     */
//    public static void addorder(Order_upsemp order) {
//        //add to database
//        String query = "INSERT INTO Order_upsemp(ORDERID,CREATORID,PRODUCTNAME,ADDRESS,PLACEDATE,AGENTID,STATUS,NOTES) VALUES(?,?,?,?,?,?,?,?)";
